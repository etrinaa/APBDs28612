...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2() => Emps.Where(emp => emp.Job == "Frontend programmer" && emp.Salary > 1000).OrderByDescending(emp => emp.Ename);
        ...
        public static int Task3() => Emps.Max(emp => emp.Salary);
        ...
        /// </summary>
        public static IEnumerable<object> Task5() => Emps.Select(emp => new { Nazwisko = emp.Ename, Praca = emp.Job });
        ...
        /// </summary>
        public static IEnumerable<object> Task6() => Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new { emp.Ename, emp.Job, dept.Dname });


        /// <summary>
        ///     SELECT Job AS Praca, COUNT(1) LiczbaPracownikow FROM Emps GROUP BY Job;
        /// </summary>
        public static IEnumerable<object> Task7() => Emps.GroupBy(emp => emp.Job).Select(group => new { Praca = group.Key, LiczbaPracownikow = group.Count() });
        ...
        /// </summary>
        public static bool Task8() => Emps.Any(emp => emp.Job == "Backend programmer");
        ...
        /// </summary>
        public static Emp Task9() => Emps.Where(emp => emp.Job == "Frontend programmer").OrderByDescending(emp => emp.HireDate).FirstOrDefault();
        ...
        /// </summary>
        public static IEnumerable<object> Task10() => Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate }).Concat(new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } });
        ...
        /// </summary>
        public static IEnumerable<Dept> Task14() => Depts.Where(dept => Emps.Count(emp => emp.Deptno == dept.Deptno) == 5 || Emps.Count(emp => emp.Deptno == dept.Deptno) == 0).OrderBy(dept => dept.Dname);
        ...
        public static IEnumerable<object> Task15()
        {
            return Emps.Where(emp => emp.Job.Contains('A'))
                       ...
                       .Select(group => new { Job = group.Key, LiczbaPracownikow = group.Count() })
        ...
        {
            var result = Emps.SelectMany(emp => Depts, (emp, dept) => (emp: emp, dept: dept));
            return result;
        }
